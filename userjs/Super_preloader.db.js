...
(function(){
    ...
    var SITEINFO_D={
        ...
        autopager:{
            ...
            remain:9999							,//剩余页面的高度..是显示高度的 remain 倍开始翻页..
            maxpage:4						,//最多翻多少页..
            ipages:[false,2]			,//立即翻页,第一项是控制是否在js加载的时候立即翻第二项(必须小于maxpage)的页数,比如[true,3].就是说JS加载后.立即                                                                   翻3页.
    ...
    var SITEINFO=[
    {
        ...
        autopager:{
            ...
            remain:9999,																									//剩余页面的高度..是显示高度的 remain 倍开始翻页(可选)
    ...
    {
        siteName:'epzw',
        url:/http:\/*\w*\.?epzw\.com\/files\/article\/html\/*\/*\/*/i,
        nextLink:'//div[@id="link"]/a[text()="下一页"]',
        autopager:{
            a_force:true,
    ...
    {
        siteName:'YY帖子列表',
        url:/http:\/\/bbs\.yys5\.com\/forum/i,
        nextLink:'//div[@class="p_bar"]/a[text()="››"]',
        autopager:{
            //         a_force:true,
            pageElement:'css;html > body > center > form[name="moderate"]',
            maxpage:4
        }
    },
    {
        siteName:'YY帖子内容',
        url:/http:\/\/bbs\.yys5\.com\/thread/i,
        nextLink:'//div[@class="p_bar"]/a[text()="››"]',
        autopager:{
            //         a_force:true,
            pageElement:'css;html > body > center > div.maintable > form',
            maxpage:4
        }
    },

    {
        ...
        nextLink:'//a[text()="下一页"]',
        autopager:{
            pageElement:'//div[@class="act mid"]/p',
            maxpage:9
        }
    },
    ...
    },
    {
        ...
        autopager:{
            ...
            pageElement:'//table[@class="result"]',
            remain:9999
        }
    },
    {
        siteName:'百度知道',
        url:/^http:\/\/zhidao\.baidu\.com\/q\?.*word=/i,
       
        nextLink:'//div[@id="pg"]/a[@class="pre-next"]',
        autopager:{
            pageElement:'//div[@id="center"]/table'
        }
    },

    {
        siteName:'百度mp3',
        url:/^http:\/\/mp3\.baidu\.com\/?.*word=/i,
        siteExample:'http://mp3.baidu.com/m?f=ms&rf=idx&tn=baidump3&ct=134217728&lf=&rn=&word=tiger&lm=-1',
        nextLink:'//a[@class="next"]',
        autopager:{
            pageElement:'//table[@class="table-song-list"]'
        }
    },
    {
    ...
    },    
    {
        ...
        // nextLink:'//a[@class="next"]',
        nextLink:'css;div#list_area> div.pager.pager-center > a.next',
        autopager:{
            pageElement:'//table[@id="thread_list_table"]'
        }
    },
    ...
    {
        siteName:'闲人动漫',
        url:/http:\/\/dm\.idler-et\.com\/comiclist\/\d+\/\d+/i,
        siteExample:'http://dm.idler-et.com/comiclist/419/5612/3.htm',
        autopager:{
            pageElement:'//div[@id="discomic"]',
            maxpage:520			
        }
    },
    ...
    {
        siteName:'07073',
        url:/http:\/\/mh\.07073\.com\/?\/*\//i,
        siteExample:'http://mh.07073.com/Y/huanyulongnv/10146_4.html',
        //   nextLink:'//span[@class="blue"]/a[@href!="#" and text()="下一页"]',
        nextLink:'//span[@class="blue"]/a[text()="下一页"]',
        autopager:{
            //   a_force:true,
            pageElement:'//div[@class="center comicpic"]',
            maxpage:520		
        }
    },
    ...
    var SITEINFO_TP=[
    {
        ...
        nextLink:'//div[@class="pages" or @class="pg"]/descendant::a[@class="next" or @class="nxt"][@href]|//a[text()="››"]',
        autopager:{
            useiframe:false,
            iloaded:false,
